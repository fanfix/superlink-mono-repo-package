...
import { AddTextSectionModalProps } from './types';
import { sharedModalStyles } from '../shared/modalStyles';

export default function AddTextSectionModal({ open, onClose, onAdd, onUpdate, onDelete, editingSection }: AddTextSectionModalProps) {
  ...
  return (
    <Modal 
      open={open} 
      onClose={handleClose} 
      title={isEditMode ? "Update Text Section" : "Add Text Section"} 
      maxWidth={480}
    >
