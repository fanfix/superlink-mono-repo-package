...
export const ParallelRowIcon: React.FC<IconProps> = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* White rectangle with rounded corners */}
    <rect x="8" y="6" width="32" height="36" rx="3" fill="#FFFFFF" stroke="#E5E5E5" strokeWidth="1"/>
    ...
    {/* Top left - grey square + grey bar */}
    <rect x="12" y="18" width="6" height="6" rx="1" fill="#9CA3AF"/>
    <rect x="12" y="26" width="6" height="2" rx="1" fill="#9CA3AF"/>
    
    {/* Top right - grey square + grey bar */}
    <rect x="26" y="18" width="6" height="6" rx="1" fill="#9CA3AF"/>
    <rect x="26" y="26" width="6" height="2" rx="1" fill="#9CA3AF"/>
    
    {/* Bottom left - grey square + grey bar */}
    <rect x="12" y="32" width="6" height="6" rx="1" fill="#9CA3AF"/>
    <rect x="12" y="40" width="6" height="2" rx="1" fill="#9CA3AF"/>
    
    {/* Bottom right - grey square + grey bar */}
    <rect x="26" y="32" width="6" height="6" rx="1" fill="#9CA3AF"/>
    <rect x="26" y="40" width="6" height="2" rx="1" fill="#9CA3AF"/>
  </svg>
);
